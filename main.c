...
int main()
{
  ...
  insert_ArvLLRB(&root, 20);
  insert_ArvLLRB(&root, 30);
  insert_ArvLLRB(&root, 21);
  insert_ArvLLRB(&root, 50);
  insert_ArvLLRB(&root, 85);
  insert_ArvLLRB(&root, 70);
  insert_ArvLLRB(&root, 15);
