...
void test_remove_linked_node()
{
    ...
    remove_linked_node(list);                 // Cria o ponteiro removed do tipo list_node
...
{
    Huff *huff = create_huff_queue(); // Cria a estrutura huff
...
void test_is_empty()
{
    Huff *huff = create_huff_queue(); // Cria o ponteiro huff do tipo Huff
...
void test_dequeue()
{
    Huff *huff = create_huff_queue();           // Cria o ponteiro huff tipo Huff
